...
void PmergeMe::displayResults(double vectorTime, double dequeTime, size_t compares_vector, size_t compares_deque)
{
	std::cout << YELLOW BOLD << "After: " << std::endl << NEUTRAL;
	...
	std::cout << YELLOW << BOLD << "Time tracking:" << NEUTRAL << std::endl;
	...
	std::cout << YELLOW << BOLD << "Performance comparison:" << NEUTRAL << std::endl;
	std::cout << BOLD << "Numbrer of comparaisons vector: " << compares_vector << NEUTRAL << std::endl;
	std::cout << BOLD << "Numbrer of comparaisons deque: " << compares_deque << NEUTRAL << std::endl;
