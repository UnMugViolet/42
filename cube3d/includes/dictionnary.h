...
# define NO_ERR "NORTH texture error.\n"
# define SO_ERR "SOUTH texture error.\n"
# define WE_ERR "WEST texture error.\n"
# define EA_ERR "EAST texture error.\n"
# define F_ERR "FLOOR color error. <R,G,B range [0-255]>\n"
